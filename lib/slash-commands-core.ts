// ---------------------------------------------------------------------------
// caduceus — core slash commands
//
// Registers 14 slash commands on the pi ExtensionAPI (the core
// persona / config / profile / wizard / diff set introduced
// across v0.1.0 – v0.4.0). The v0.5.0 lifecycle commands live
// in lib/slash-commands-sdd.ts and lib/slash-commands-review.ts
// and are wired together by lib/slash-commands.ts and the
// extension entry (extensions/caduceus.ts).
...
export function registerCoreSlashCommands(
  pi: ExtensionAPI,
  deps: CommandDeps,
): void {
  // /caduceus:status --------------------------------------------------------
